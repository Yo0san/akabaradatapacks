playsound mgs:glock18.fire player @s ~ ~1000000 ~ 10000000
playsound mgs:glock18.fire player @a[distance=0.01..48] ~ ~ ~ 3
function mgs:guns/_common/playsound/small
function mgs:core/fire_slow
execute if score enableCasing V matches 1.. run function mgs:guns/016/handler_casing
