playsound mgs:m4.fire player @s ~ ~1000000 ~ 10000000
playsound mgs:m4.fire player @a[distance=0.01..48] ~ ~ ~ 3
function mgs:guns/_common/playsound/med
function mgs:core/fire
execute if score enableCasing V matches 1.. run function mgs:guns/005/handler_casing
