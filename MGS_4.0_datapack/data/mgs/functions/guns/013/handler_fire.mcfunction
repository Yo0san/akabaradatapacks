playsound mgs:deagle.fire player @s ~ ~1000000 ~ 10000000
playsound mgs:deagle.fire player @a[distance=0.01..48] ~ ~ ~ 3
function mgs:guns/_common/playsound/smallmed
function mgs:core/fire_slow
execute if score enableCasing V matches 1.. run function mgs:guns/013/handler_casing
